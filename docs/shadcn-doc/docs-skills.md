...
- [CLI](docs-cli.md) — Full CLI command reference
- [MCP Server](docs-mcp.md) — Connect the MCP server for registry access
- [Theming](docs-theming.md) — CSS variables and customization
- [Registry](docs-registry.md) — Building and publishing custom registries
