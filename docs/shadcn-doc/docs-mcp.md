...
For more details on registry authentication, see the [Authentication documentation](docs-registry-authentication.md).
...
- [Registry Documentation](docs-registry.md) - Complete guide to shadcn registries
- [Namespaces](docs-registry-namespace.md) - Configure multiple registry sources
- [Authentication](docs-registry-authentication.md) - Secure your private registries
