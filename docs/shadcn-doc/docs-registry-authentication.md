...
With [namespaced registries](docs-registry-namespace.md), you can set up multiple registries with different authentication:
...
To set up authentication with multiple registries and advanced patterns, see the [Namespaced Registries](docs-registry-namespace.md) documentation. It covers:
