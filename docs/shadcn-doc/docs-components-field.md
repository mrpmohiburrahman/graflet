...
See the [Form](docs-forms.md) documentation for building forms with the `Field` component and [React Hook Form](docs-forms-react-hook-form.md), [Tanstack Form](docs-forms-tanstack-form.md), or [Formisch](docs-forms-formisch.md).
...
To enable RTL support in shadcn/ui, see the [RTL configuration guide](docs-rtl.md).
