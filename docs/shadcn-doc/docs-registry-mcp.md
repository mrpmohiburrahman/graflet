...
The [shadcn MCP server](docs-mcp.md) works out of the box with any shadcn-compatible registry. You do not need to do anything special to enable MCP support for your registry.
...
This file must be a valid JSON file that conforms to the [registry schema](docs-registry-registry-json.md).
...
You can read more about the MCP server in the [MCP documentation](docs-mcp.md).
