...
Update the dark mode colors in your `globals.css` file to new OKLCH colors. See the [Base Colors](docs-theming.md#base-colors) reference for a list of colors.
