...
This API is only available inside [React Server Components](reference-rsc-use-client.md).
...
To prevent passing an object containing sensitive data, see [`taintObjectReference`](reference-react-experimental_taintObjectReference.md).
