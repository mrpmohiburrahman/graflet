...
Validates that components and hooks follow the [Rules of Hooks](reference-rules-rules-of-hooks.md).
...
Learn more: [`use` API Reference](reference-react-use.md)
...
Learn more: [Fetching Data](learn-synchronizing-with-effects.md#fetching-data)
