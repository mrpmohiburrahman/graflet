...
React Compiler is designed to handle code that follows the [Rules of React](reference-rules.md). When it encounters code that might break these rules, it safely skips optimization rather than risk changing your app's behavior.
...
- Review the [Rules of React](reference-rules.md) to prevent issues
- Check the [incremental adoption guide](learn-react-compiler-incremental-adoption.md) for gradual rollout strategies
---
