...
December 11, 2025 by [The React Team](community-team.md)
...
Please see [the instructions in the previous post](blog-2025-12-03-critical-security-vulnerability-in-react-server-components.md#update-instructions) for upgrade steps.
...
These vulnerabilities are present in the same packages and versions as [CVE-2025-55182](blog-2025-12-03-critical-security-vulnerability-in-react-server-components.md).
