...
They are special in React because passing the `value` prop to them makes them *[controlled.](reference-react-dom-components-input.md#controlling-an-input-with-a-state-variable)*
...
* [`<link>`](reference-react-dom-components-link.md)
* [`<meta>`](reference-react-dom-components-meta.md)
* [`<script>`](reference-react-dom-components-script.md)
* [`<style>`](reference-react-dom-components-style.md)
* [`<title>`](reference-react-dom-components-title.md)
