...
- Learn about [debugging techniques](learn-react-compiler-debugging.md) for compiled code
- Check the [configuration options](reference-react-compiler-configuration.md) for all compiler options
- Explore [compilation modes](reference-react-compiler-compilationMode.md) for selective optimization
---
