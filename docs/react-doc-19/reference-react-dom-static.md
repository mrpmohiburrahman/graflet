...
* <ExperimentalBadge /> [`resumeAndPrerender`](reference-react-dom-static-resumeAndPrerender.md) continues a prerendered React tree to static HTML with a [Readable Web Stream](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream).
...
* <ExperimentalBadge /> [`resumeAndPrerenderToNodeStream`](reference-react-dom-static-resumeAndPrerenderToNodeStream.md) continues a prerendered React tree to static HTML with a [Node.js Stream.](https://nodejs.org/api/stream.html)
