...
If you find yourself fighting with the linter, you likely need to restructure your code. See [Removing Effect Dependencies](learn-removing-effect-dependencies.md) to learn how.
