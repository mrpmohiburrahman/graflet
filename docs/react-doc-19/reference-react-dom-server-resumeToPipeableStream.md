...
This API is specific to Node.js. Environments with [Web Streams,](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API) like Deno and modern edge runtimes, should use [`resume`](reference-react-dom-server-renderToReadableStream.md) instead.
...
The [usage section of `prerender`](reference-react-dom-static-prerender.md#usage) includes examples of how to use `prerenderToNodeStream` specifically.
---
