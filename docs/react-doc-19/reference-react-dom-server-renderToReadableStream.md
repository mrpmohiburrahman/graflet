...
This API depends on [Web Streams.](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API) For Node.js, use [`renderToPipeableStream`](reference-react-dom-server-renderToPipeableStream.md) instead.
