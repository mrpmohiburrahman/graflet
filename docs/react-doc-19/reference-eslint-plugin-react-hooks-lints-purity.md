...
Validates that [components/hooks are pure](reference-rules-components-and-hooks-must-be-pure.md) by checking that they do not call known-impure functions.
...
Instead, [move the impure function outside of render](reference-rules-components-and-hooks-must-be-pure.md#components-and-hooks-must-be-idempotent):
