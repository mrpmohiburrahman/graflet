...
Validates against mutating props, state, and other values that [are immutable](reference-rules-components-and-hooks-must-be-pure.md#props-and-state-are-immutable).
