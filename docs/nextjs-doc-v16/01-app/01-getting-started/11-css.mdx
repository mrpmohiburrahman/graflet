...
- [Sass](../02-guides/sass.mdx)
- [CSS-in-JS](../02-guides/css-in-js.mdx)
...
> **Good to know:** If you need broader browser support for very old browsers, see the [Tailwind CSS v3 setup instructions](../02-guides/tailwind-v3-css.mdx).
...
Due to the global nature of stylesheets, and to avoid conflicts, you should import them inside [`pages/_app.js`](../../02-pages/03-building-your-application/01-routing/05-custom-app.mdx).
...
- You can use the [`cssChunking`](../03-api-reference/05-config/01-next-config-js/cssChunking.mdx) option in `next.config.js` to control how CSS is chunked.

## Development vs Production

- In development (`next dev`), CSS updates apply instantly with [Fast Refresh](../../03-architecture/fast-refresh.mdx).
