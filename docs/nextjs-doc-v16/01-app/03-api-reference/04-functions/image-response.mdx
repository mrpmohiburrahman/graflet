...
You can use `ImageResponse` in a [`opengraph-image.tsx`](../03-file-conventions/01-metadata/opengraph-image.mdx) file to generate Open Graph images at build time or dynamically at request time.
