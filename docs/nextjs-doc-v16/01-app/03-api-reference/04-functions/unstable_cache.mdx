...
> **Note:**
> This API has been replaced by [`use cache`](../01-directives/use-cache.mdx) in Next.js 16.
> We recommend opting into [Cache Components](../../01-getting-started/08-caching.mdx) and replacing `unstable_cache` with the `use cache` directive.
...
> - This API uses Next.js' built-in cache to persist the result across requests and deployments. See [Caching and Revalidating](../../01-getting-started/08-caching.mdx).
