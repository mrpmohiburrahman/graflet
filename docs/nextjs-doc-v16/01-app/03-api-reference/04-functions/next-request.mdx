...
| ----------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `basePath`        | `string`                  | The [base path](../../../02-pages/04-api-reference/04-config/01-next-config-js/basePath.mdx) of the URL.                                                  |
| `buildId`         | `string` \| `undefined`   | The build identifier of the Next.js application. Can be [customized](../../../02-pages/04-api-reference/04-config/01-next-config-js/generateBuildId.mdx). |
| `defaultLocale`   | `string` \| `undefined`   | The default locale for [internationalization](../../../02-pages/02-guides/internationalization.mdx).                                                |
| `domainLocale`    |                           |                                                                                                                                        |
...
| Property       | Type                    | Description                                                                                                                          |
| -------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `basePath`     | `string`                | The [base path](../05-config/01-next-config-js/basePath.mdx) of the URL.                                                  |
| `buildId`      | `string` \| `undefined` | The build identifier of the Next.js application. Can be [customized](../05-config/01-next-config-js/generateBuildId.mdx). |
| `pathname`     | `string`                | The pathname of the URL.                                                                                                             |
| `searchParams` | `Object`                | The search parameters of the URL.                                                                                                    |

> **Note:** The internationalization properties from the Pages Router are not available for usage in the App Router. Learn more about [internationalization with the App Router](../../02-guides/internationalization.mdx).
