...
- [Prefetching](../../01-getting-started/04-linking-and-navigating.mdx#prefetching) is disabled or in progress meaning navigation is blocked.
- The destination route is dynamic **and** doesn't include a [`loading.js`](../03-file-conventions/loading.mdx) file that would allow an instant navigation.
