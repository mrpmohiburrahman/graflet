...
| `--turbopack`                            | Force enable [Turbopack](../08-turbopack.mdx) (enabled by default). Also available as `--turbo`.                                       |
| `--webpack`                              | Use Webpack instead of the default [Turbopack](../08-turbopack.mdx) bundler for development.                                           |
...
`next experimental-analyze` analyzes your application's bundle output using [Turbopack](../08-turbopack.mdx). This command helps you understand the size and composition of your bundles, including JavaScript, CSS, and other assets. This command doesn't produce an application build.
...
See [Package Bundling](../../02-guides/package-bundling.mdx#optimizing-large-bundles) for optimization strategies.
