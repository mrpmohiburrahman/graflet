...
The **forbidden** file is used to render UI when the [`forbidden`](../04-functions/forbidden.mdx) function is invoked during authentication. Along with allowing you to customize the UI, Next.js will return a `403` status code.
