...
Unlike [server-side instrumentation](../../02-guides/instrumentation.mdx), you do not need to export any specific functions. You can write your monitoring code directly in the file:
