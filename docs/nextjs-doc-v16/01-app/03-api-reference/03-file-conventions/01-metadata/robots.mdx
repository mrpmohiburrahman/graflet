...
> **Good to know**: `robots.js` is a special Route Handler that is cached by default unless it uses a [Request-time API](../../../04-glossary.mdx#request-time-apis) or [dynamic config](../../../02-guides/caching-without-cache-components.mdx#dynamic) option.
