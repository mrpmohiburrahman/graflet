...
If using [Server Actions](../../../01-getting-started/07-mutating-data.mdx), set the `maxDuration` at the page level to change the default timeout of all Server Actions used on the page.
