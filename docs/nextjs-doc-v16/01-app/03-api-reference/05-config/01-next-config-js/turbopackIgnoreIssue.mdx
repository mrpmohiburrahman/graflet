...
The `turbopack.ignoreIssue` option allows you to filter out specific [Turbopack](../../08-turbopack.mdx) errors and warnings so they do not appear in the CLI output or the error overlay. This is useful for suppressing known warnings that do not affect your application, such as intentionally unresolved optional dependencies.
