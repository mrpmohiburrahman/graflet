...
Dependencies used inside [Server Components](../../../01-getting-started/05-server-and-client-components.mdx) and [Route Handlers](../../03-file-conventions/route.mdx) will automatically be bundled by Next.js.
