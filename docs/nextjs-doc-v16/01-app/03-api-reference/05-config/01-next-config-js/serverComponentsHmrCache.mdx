...
> **Good to know:** For better observability, we recommend using the [`logging.fetches`](logging.mdx) option which logs fetch cache hits and misses in the console during development.
