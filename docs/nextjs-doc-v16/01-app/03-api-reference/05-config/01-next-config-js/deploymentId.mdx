...
The `deploymentId` option allows you to set an identifier for your deployment. This identifier is used for [version skew](../../../02-guides/self-hosting.mdx#version-skew) protection and cache busting during rolling deployments.
...
- [Self-Hosting - Version Skew](../../../02-guides/self-hosting.mdx#version-skew)
- [generateBuildId](generateBuildId.mdx)
