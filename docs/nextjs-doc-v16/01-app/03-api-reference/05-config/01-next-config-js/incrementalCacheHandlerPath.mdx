...
View an example of a [custom cache handler](../../../02-guides/self-hosting.mdx#configuring-caching) and learn more about the implementation.
...
Returns `Promise<void>`. Learn more about [revalidating data](../../../02-guides/incremental-static-regeneration.mdx) or the [`revalidateTag()`](../../04-functions/revalidateTag.mdx) function.
...
Learn how to [configure ISR](../../../02-guides/self-hosting.mdx#caching-and-isr) when self-hosting Next.js.
