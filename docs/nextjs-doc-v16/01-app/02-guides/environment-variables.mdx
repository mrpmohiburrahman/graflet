...
This loads `process.env.DB_HOST`, `process.env.DB_USER`, and `process.env.DB_PASS` into the Node.js environment automatically allowing you to use them in [Next.js data fetching methods](../../02-pages/03-building-your-application/03-data-fetching/index.mdx) and [API routes](../../02-pages/03-building-your-application/01-routing/07-api-routes.mdx).

For example, using [`getStaticProps`](../../02-pages/03-building-your-application/03-data-fetching/01-get-static-props.mdx):
...
> This loads `process.env.DB_HOST`, `process.env.DB_USER`, and `process.env.DB_PASS` into the Node.js environment automatically allowing you to use them in [Route Handlers](../03-api-reference/03-file-conventions/route.mdx).
...
- If you are using a [`/src` directory](../03-api-reference/03-file-conventions/src-folder.mdx), `.env.*` files should remain in the root of your project.
