...
> You may also wish to configure the client-side router to disallow client-side redirects to filename routes; for that refer to [`router.beforePopState`](../../02-pages/04-api-reference/03-functions/use-router.mdx#routerbeforepopstate).
