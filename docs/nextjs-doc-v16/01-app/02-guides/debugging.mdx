...
If you're [changing the port number](../../02-pages/04-api-reference/05-cli/next.mdx#next-dev-options) your application starts on, replace the `3000` in `http://localhost:3000` with the port you're using instead.
