...
Next.js provides built-in support for creating a [web app manifest](../03-api-reference/03-file-conventions/01-metadata/manifest.mdx) using the App Router. You can create either a static or dynamic manifest file:
...
- You are [running locally with HTTPS](../03-api-reference/06-cli/next.mdx#using-https-during-development)
