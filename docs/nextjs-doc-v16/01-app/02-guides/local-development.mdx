...
[Learn more about Turbopack](/blog/turbopack-for-development-stable). See our [upgrade guides](upgrading/index.mdx) and codemods for more information.

### 3. Check your imports

The way you import code can greatly affect compilation and bundling time. Learn more about [optimizing package bundling](package-bundling.mdx) and explore tools like [Dependency Cruiser](https://github.com/sverweij/dependency-cruiser) or [Madge](https://github.com/pahen/madge).
...
Consider if you really need them for local development. You can optionally only include certain tools for production builds, or explore using the default Turbopack bundler and configuring [loaders](../03-api-reference/05-config/01-next-config-js/turbopack.mdx#configuring-webpack-loaders) instead.

### 6. Optimize memory usage

If your app is very large, it might need more memory.

[Learn more about optimizing memory usage](memory-usage.mdx).
...
[Learn more about the experimental option](../03-api-reference/05-config/01-next-config-js/serverComponentsHmrCache.mdx).
...
[Learn more about Docker deployment](../01-getting-started/17-deploying.mdx#docker) for production use.
...
[Learn more about fetch logging](../03-api-reference/05-config/01-next-config-js/logging.mdx).
