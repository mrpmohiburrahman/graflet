...
The `redirect` function allows you to redirect the user to another URL. You can call `redirect` in [Server Components](../01-getting-started/05-server-and-client-components.mdx), [Route Handlers](../03-api-reference/03-file-conventions/route.mdx), and [Server Functions](../01-getting-started/07-mutating-data.mdx).
...
See the [`redirect` API reference](../03-api-reference/04-functions/redirect.mdx) for more information.

## `permanentRedirect` function

The `permanentRedirect` function allows you to **permanently** redirect the user to another URL. You can call `permanentRedirect` in [Server Components](../01-getting-started/05-server-and-client-components.mdx), [Route Handlers](../03-api-reference/03-file-conventions/route.mdx), and [Server Functions](../01-getting-started/07-mutating-data.mdx).
...
See the [`permanentRedirect` API reference](../03-api-reference/04-functions/permanentRedirect.mdx) for more information.
...
> **Good to know**:
>
> - If you don't need to programmatically navigate a user, you should use a [`<Link>`](../03-api-reference/02-components/link.mdx) component.

<AppOnly>

See the [`useRouter` API reference](../03-api-reference/04-functions/use-router.mdx) for more information.

</AppOnly>

<PagesOnly>

See the [`useRouter` API reference](../../02-pages/04-api-reference/03-functions/use-router.mdx) for more information.
...
`redirects` supports [path](../03-api-reference/05-config/01-next-config-js/redirects.mdx#path-matching), [header, cookie, and query matching](../03-api-reference/05-config/01-next-config-js/redirects.mdx#header-cookie-and-query-matching), giving you the flexibility to redirect users based on an incoming request.
...
See the [Proxy](../03-api-reference/03-file-conventions/proxy.mdx) documentation for more information.
...
In [Proxy](../03-api-reference/03-file-conventions/proxy.mdx), you can read from a database such as Vercel's [Edge Config](https://vercel.com/docs/edge-config/get-started) or [Redis](https://vercel.com/docs/redis), and redirect the user based on the incoming request:
...
If it does, forward the request to a <AppOnly>[Route Handler](../03-api-reference/03-file-conventions/route.mdx)</AppOnly> <PagesOnly>[API Routes](../../02-pages/03-building-your-application/01-routing/07-api-routes.mdx)</PagesOnly> which will check the actual file and redirect the user to the appropriate URL. This avoids importing a large redirects file into Proxy, which can slow down every incoming request.
