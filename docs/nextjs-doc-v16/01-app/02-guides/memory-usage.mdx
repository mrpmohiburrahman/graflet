...
The [Bundle Analyzer](package-bundling.mdx) can help you investigate large dependencies in your application that may be able to be removed to improve performance and memory usage.
...
You can disable this behavior by adding a [custom Webpack configuration](../03-api-reference/05-config/01-next-config-js/webpack.mdx) to your application:
...
- [Ignoring TypeScript Errors](../03-api-reference/05-config/02-typescript.mdx#disabling-typescript-errors-in-production)
