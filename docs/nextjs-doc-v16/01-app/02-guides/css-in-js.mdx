...
Then, wrap your [root layout](../03-api-reference/03-file-conventions/layout.mdx#root-layout) with the registry:
...
> - For advanced use cases where you need to configure individual properties of styled-components compilation, you can read our [Next.js styled-components API reference](../../03-architecture/nextjs-compiler.mdx#styled-components) to learn more.
