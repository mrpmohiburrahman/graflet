...
View the [API Reference](../../02-pages/04-api-reference/03-functions/use-report-web-vitals.mdx) for more information.
...
View the [API Reference](../03-api-reference/04-functions/use-report-web-vitals.mdx) for more information.
