...
The [`@next/bundle-analyzer`](https://www.npmjs.com/package/@next/bundle-analyzer) is a plugin that helps you manage the size of your application bundles. It generates a visual report of the size of each package and their dependencies. You can use the information to remove large dependencies, split, or [lazy-load](lazy-loading.mdx) your code.
...
> **Good to know:** Next.js also optimizes some libraries automatically, thus they do not need to be included in the `optimizePackageImports` list. See the [full list](../03-api-reference/05-config/01-next-config-js/optimizePackageImports.mdx) of supported packages.
...
You can opt specific packages out of bundling using the [`serverExternalPackages`](../03-api-reference/05-config/01-next-config-js/serverExternalPackages.mdx) option in your `next.config.js`.
...
To bundle specific packages, you can use the [`transpilePackages`](../03-api-reference/05-config/01-next-config-js/transpilePackages.mdx) option in your `next.config.js`.
...
To automatically bundle all packages, you can use the [`bundlePagesRouterDependencies`](../../02-pages/04-api-reference/04-config/01-next-config-js/bundlePagesRouterDependencies.mdx) option in your `next.config.js`. This option defaults to `false`.
...
If you identify packages that shouldn't be in the bundle, you can opt specific packages out of automatic bundling using the [`serverExternalPackages`](../../02-pages/04-api-reference/04-config/01-next-config-js/serverExternalPackages.mdx) option in your `next.config.js`:
