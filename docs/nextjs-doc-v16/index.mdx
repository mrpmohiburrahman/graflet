...
- [Getting Started](01-app/01-getting-started/index.mdx): Step-by-step tutorials to help you create a new application and learn the core Next.js features.
- [Guides](01-app/02-guides/index.mdx): Tutorials on specific use cases, choose what's relevant to you.
- [API Reference](01-app/03-api-reference/index.mdx): Detailed technical reference for every feature.
...
At the top of the sidebar, you'll notice a dropdown menu that allows you to switch between the [App Router](01-app/index.mdx) and the [Pages Router](02-pages/index.mdx) docs.
