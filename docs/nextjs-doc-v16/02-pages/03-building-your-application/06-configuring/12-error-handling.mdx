...
Next.js provides a static 500 page by default to handle server-side errors that occur in your application. You can also [customize this page](../01-routing/08-custom-error.mdx#customizing-the-500-page) by creating a `pages/500.js` file.

Having a 500 page in your application does not show specific errors to the app user.

You can also use [404 page](../01-routing/08-custom-error.mdx#404-page) to handle specific runtime error like `file not found`.
