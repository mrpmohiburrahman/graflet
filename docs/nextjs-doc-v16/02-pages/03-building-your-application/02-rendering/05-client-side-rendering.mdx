...
1. Using React's `useEffect()` hook inside your pages instead of the server-side rendering methods ([`getStaticProps`](../03-data-fetching/01-get-static-props.mdx) and [`getServerSideProps`](../03-data-fetching/03-get-server-side-props.mdx)).
