...
Next.js compiles CSS for its [built-in CSS support](../../01-app/01-getting-started/11-css.mdx) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](../../01-app/01-getting-started/11-css.mdx).
