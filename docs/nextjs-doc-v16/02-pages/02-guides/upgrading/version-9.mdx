...
If you previously copied the [Custom `<App>`](../../03-building-your-application/01-routing/05-custom-app.mdx) example, you may be able to remove your `getInitialProps`.
