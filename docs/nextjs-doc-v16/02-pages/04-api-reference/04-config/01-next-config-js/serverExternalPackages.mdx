...
Opt-out specific dependencies from being included in the automatic bundling of the [`bundlePagesRouterDependencies`](bundlePagesRouterDependencies.mdx) option.
