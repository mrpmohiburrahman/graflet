...
To include polyfills, you can import them into the [`instrumentation-client.js` file](../01-app/03-api-reference/03-file-conventions/instrumentation-client.mdx).
...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](../02-pages/03-building-your-application/01-routing/05-custom-app.mdx) or the individual component.
...
Next.js has built-in TypeScript support. [Learn more here](../02-pages/04-api-reference/04-config/01-typescript.mdx).

### Customizing Babel Config (Advanced)

You can customize babel configuration. [Learn more here](../02-pages/02-guides/babel.mdx).
