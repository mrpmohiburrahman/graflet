...
This option has been superseded by [`optimizePackageImports`](../01-app/03-api-reference/05-config/01-next-config-js/optimizePackageImports.mdx) in Next.js 13.5. We recommend upgrading to use the new option that does not require manual configuration of import paths.
