...
It’s not easy, though.  It takes dedication, hard work, and some luck to get your first customer.  As Lao Tzu said: “*A journey of a thousand miles begins with a single step*“.
...
![Exploring product ideas](https://freemius.com/blog/wp-content/uploads/2017/03/Exploring-product-ideas.jpg)

One thing that I’ve learned through my [many](http://web.archive.org/web/20150107074643/https://redemfit.com/) [failed](http://web.archive.org/web/20110223170015/http://mailtally.com/) [products](https://web.archive.org/web/20100503161432/http://www.shouldigetthebook.com/) is that if you want to be successful, it helps a **lot** if you are solving a problem that you yourself have.  Back when I was still a freelance WordPress developer I often ran into the problem of updating themes and plugins on client hosts. It was always a big pain to do, so I thought that being able to hook into the WordPress update system would make life a lot easier. [Kernl](https://kernl.us/) was born from this problem, and it formed the core of the product.
...
A year or so ago a coworker introduced me to the term “[bikeshedding](https://en.wiktionary.org/wiki/bikeshedding)“.  Bikeshedding is a term that was coined as a metaphor for [Parkinson’s Law of Triviality](https://en.wikipedia.org/wiki/Law_of_triviality).  The story goes that there is a group of engineers working to build a nuclear power plant, but instead of spending their time wisely and debating reactor design, they end up wasting all their time on what color the bikeshed out in front of the power plant should be.
...
![Kernl homepage screenshot](https://freemius.com/blog/wp-content/uploads/2017/03/Kernl-homepage-screenshot-1024x314.png)
...
![Short term goal - Make a car payment](https://freemius.com/blog/wp-content/uploads/2017/03/Short-term-goal-Make-a-car-payment.jpeg)
