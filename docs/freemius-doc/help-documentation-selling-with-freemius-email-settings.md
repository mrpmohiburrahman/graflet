...
Make sure you setup [DKIM](https://freemius.com/help/documentation/emails/email-deliverability/#domainkeys_identified_mail_dkim) to verify your custom email addresses so as to [minimize delivery issues](https://freemius.com/help/documentation/emails/email-deliverability/). Otherwise Freemius [will fallback](#fallback-sender-behavior-for-transactional-emails) to using its own email addresses for sending transactional emails.
...
You can configure custom addresses and [authenticate your domain](https://freemius.com/help/documentation/emails/email-deliverability/#domainkeys_identified_mail_dkim) to avoid this fallback behavior.