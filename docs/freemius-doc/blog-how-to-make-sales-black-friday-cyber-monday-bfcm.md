Got the Black Friday / Cyber Monday jitters?
...
Look to your peers and community for assistance. The WordPress community, for example, offers a wealth of battle-tested insights. As [Katie Keith](https://x.com/KatieKeithBarn2) notes in the same episode:
...
1. A [BFCM landing page](black-friday-cyber-monday.md) creates hype by showcasing your products in a new, exciting light and drives sales with FOMO triggers like countdown timers.
...
[This blog post](https://www.commoninja.com/blog/create-converting-black-friday-landing-page#What-Makes-a-Landing-Page-Good?) provides valuable insights into the key elements needed to craft a high-converting BFCM landing page:
...
![Elementor BFCM offer](https://freemius.com/blog/wp-content/uploads/2023/11/elementor-bfcm-offer.png)

An example of a dedicated landing page from Elementor
...
![Yes - no poll](https://freemius.com/blog/wp-content/uploads/2023/11/yes-no-poll.gif)
...
![Grammarly BFCM email](https://freemius.com/blog/wp-content/uploads/2023/11/grammarly-bfcm-email.png)

An example of an early BFCM email (from Grammarly)

### Choose the Right Type of Offer

BFCM campaigns should be about creating more value, “not racing to the bottom with the biggest discount,” as [Jack Paxton](https://www.linkedin.com/in/jackpaxton/), founder of [Top Growth Marketing](https://topgrowthmarketing.com/) puts it.
...
If you don’t have complementary products of your own, consider partnering with another maker who offers products within your niche. Promoting partner products can lead to mutually beneficial affiliate or [cross-promotion opportunities](blog-recommending-bundling-plugins-themes.md).
...
[Elementor executed this strategy](https://elementor.com/blog/black-friday-coming-soon/) recently with additional prizes like 1:1s with their team.

#### 3. Donate Instead of Discount

Consider donating a percentage of your BFCM sales to charity to support a meaningful cause and create goodwill among customers. You can either select a cause that aligns with your values or let customers pick their favorite. Freemius [recently had a campaign](https://freemius.com/blog/freemius-10-campaign-results/) that inspired people to rally behind a worthy cause, allowing us to raise money to donate to a nonprofit.
...
[Offer more site activations or licenses](https://freemius.com/blog/marketing-plugins-themes-black-friday-cyber-monday-2019/#offering_extra_sites_in_your_license_without_reducing_the_avg_sale_size) in your plans instead of lowering prices — this benefits sellers by maintaining ASP and buyers by providing future flexibility.
...
Referral programs can be an impactful, low-cost way to present your offer without devaluing your product. [Marijana Gligoric](https://www.linkedin.com/in/marijana-gligoric/), co-founder and CEO of [brigit.dev](https://brigit.dev/) has seen it work well in practice.
...
For luck, we’ve added a few more tips and practices not covered in the video 😉
...
Google data, highlighted in [an analysis by Alex Denning](https://getellipsis.com/blog/black-friday-2020/), shows significant search volume both six weeks before and two weeks after BFCM.
...
1. Access your Developer Dashboard
2. Navigate to Coupons → Add Coupon
3. Configure discount (recommended: start at 5%)
4. Create a 60-minute FOMO timer

[![Checkout Freemius discount](https://freemius.com/blog/wp-content/uploads/2023/11/checkout-freemius-discount.jpeg)](https://freemius.com/blog/how-to-make-sales-black-friday-cyber-monday-bfcm/checkout-freemius-discount/)

[![Adding a coupon to Freemius checkout](https://freemius.com/blog/wp-content/uploads/2023/11/adding-a-coupon-to-freemius-checkout.jpeg)](https://freemius.com/blog/how-to-make-sales-black-friday-cyber-monday-bfcm/adding-a-coupon-to-freemius-checkout/)
...
Be sure to use multiple distribution channels — [a dedicated](black-friday-cyber-monday.md) [Black Friday Cyber Monday landing page](black-friday-cyber-monday.md), email campaign, pop-up ads, and more — and see which ones work best for future reference.
...
![Checkout discount automated](https://freemius.com/blog/wp-content/uploads/2023/11/checkout-discount-automated.png)
...
With [Freemius](index.md), you can create multiple coupons with the same coupon code and different settings, and the checkout will automatically apply the coupon according to the state of the cart (the product, number of licenses, billing cycle, and more).

![BFCM coupons in Freemius](https://freemius.com/blog/wp-content/uploads/2023/11/bfcm-coupons-in-freemius.png)
...
![Big shark in 'Finding Nemo' saying "Hello" to Marlin in an article about BFCM](https://freemius.com/blog/wp-content/uploads/2023/11/big-shark-in-finding-nemo-saying-hello-to-marlin-in-an-article-about-bfcm.gif)
...
![Early Black Friday Cyber Monday sales email by Columbia](https://freemius.com/blog/wp-content/uploads/2023/11/early-black-friday-cyber-monday-sales-email-by-columbia-1.png)

Example of an early Black Friday sales email (from Columbia)
...
Over the past several years, we’ve leveraged our network in a collective effort to cross-promote our makers’ products by showcasing promotions on a dedicated [BFCM landing page](black-friday-cyber-monday.md).
...
![BFCM 2024 Freemius landing page](https://freemius.com/blog/wp-content/uploads/2023/11/bfcm-2024-freemius-landing-page.png)
...
### Promotions via the Customer Portal

![User dashboard promotion](https://freemius.com/blog/wp-content/uploads/2023/11/user-dashboard-promotion.png)

As per the above screenshot: When a user logs into the [Customer Portal](wordpress-user-dashboard.md) of a participating seller, they’ll see an eye-catching header advertising the Freemius makers’ community BFCM deals.

### Promotions Through Transactional Emails

![Transactional email Freemius](https://freemius.com/blog/wp-content/uploads/2023/11/transactional-email-freemius.png)
...
Please note that these promo perks are exclusive to software companies selling with Freemius. Feel free to [get in touch](https://freemius.com/cdn-cgi/l/email-protection#abc8c4c5dfcac8dfebcdd9cecec6c2ded885c8c4c6) if you’d like to join the club.
...
Don’t forget to browse our [Black Friday / Cyber Monday 2024 showcase](black-friday-cyber-monday.md) now and explore 150+ software products at up to 80% off.